...
%
% Regla al editar
%   NO se traducen: titulos de papers, revistas y congresos, ni titulos
%   de proyectos de investigacion (FONDECYT, DIPRES). Cada uno va en su
%   idioma original en las dos versiones del CV.
%   SI se traducen: encabezados, cargos, prosa (premios, actividades) y
%   los titulos y objetivos de las consultorias.
%
% IMPORTANTE: nunca pongas & ni \\ dentro de un \tr{}{}. Rompe la tabla.
%
% Convencion: el espanol redactado por Claude y aun no revisado por Hugo
% se marca al final de la linea con % [REVISAR]. Hoy no queda ninguna;
% build-cv.ps1 avisa si vuelven a aparecer.
% =====================================================================
...
2025-- & \tr{Principal Researcher}{Investigador Principal}, \tr{Millennium Nucleus in Just Transport}{N\'{u}cleo Milenio en Transporte Justo}. \\
2025-- & \tr{Principal Researcher}{Investigador Principal}, \tr{Center for Advanced Transportation, Logistics and Economic Competitiveness (CATLEC)}{Centro Avanzado de Transporte, Log\'{i}stica y Competitividad Econ\'{o}mica (CATLEC)}. \\
...
\tr{M.Sc. in Engineering Sciences, major in Transport. Universidad de Chile, 2010.}{Mag\'{i}ster en Ciencias de la Ingenier\'{i}a, menci\'{o}n Transporte. Universidad de Chile, 2010.} \\[4pt]
\tr{Professional degree: Civil Engineer, major in Transport. Universidad de Chile, 2010.}{T\'{i}tulo de Ingeniero Civil, menci\'{o}n Transporte. Universidad de Chile, 2010.}
...
2020 & \tr{Co-Investigator}{Co-investigador}, \tr{Research Project}{Proyecto} ``Evaluación de impacto del Programa de Subsidio de Arriendo''.
\tr{Fondo de Evaluaci\'{o}n de Impacto (Impact Evaluation Fund), Budget Office (DIPRES), Chile.}{Fondo de Evaluaci\'{o}n de Impacto, Direcci\'{o}n de Presupuestos (DIPRES), Chile.}  \\ \\
...
\begin{tabularx}{\textwidth}{l X}
2024-2025 & \textbf{\tr{Efficiency of public transport subsidization in the Metropolitan Area of Buenos Aires.}{Eficiencia del subsidio al transporte p\'{u}blico en el \'{A}rea Metropolitana de Buenos Aires.}} \\ \noalign{\smallskip}
...
2023--2024 & \textbf{\tr{Decomposition and evolution of housing prices.}{Descomposici\'{o}n y evoluci\'{o}n de los precios de las viviendas.}} \\ \noalign{\smallskip}
					& -- \tr{Client}{Cliente}: \tr{Center for Public Policy UC (Centro de Pol\'{i}ticas P\'{u}blicas UC) and the Chilean Association of Real Estate Developers (ADI)}{Centro de Pol\'{i}ticas P\'{u}blicas UC y Asociaci\'{o}n de Desarrolladores Inmobiliarios (ADI)} \\
					& -- \tr{Objectives}{Objetivos}: \tr{Expert advisor to the study ``Estudio de descomposici\'{o}n y evoluci\'{o}n de los precios de las viviendas'', part of the project ``Vivienda asequible: hablemos del precio''. Advised the team on the econometric methodology and the interpretation of results, and participated in the expert dialogue sessions.}{Asesor experto del ``Estudio de descomposici\'{o}n y evoluci\'{o}n de los precios de las viviendas'', parte del proyecto ``Vivienda asequible: hablemos del precio''. Asesor\'{i}a al equipo en la metodolog\'{i}a econom\'{e}trica y la interpretaci\'{o}n de resultados, y participaci\'{o}n en las sesiones de di\'{a}logo entre expertos.} \\
\noalign{\smallskip}
...
2014 & \tr{Best paper by a Ph.D. student in the Symposium of the European Association for Research in Transportation. Paper:}{Mejor art\'{i}culo de un estudiante de doctorado en el Symposium of the European Association for Research in Transportation. Art\'{i}culo:} ``Input third-degree price discrimination by congestible facilities''. \\ \noalign{\medskip}
     & \tr{Ph.D Scholarship ``Becas-Chile''. Awarded free tuition.}{Beca de doctorado ``Becas-Chile''. Incluy\'{o} arancel completo.} \\ \\
...
2011 & \tr{Prize \emph{Colegio de Ingenieros de Chile} (College of Engineers of Chile) to the best new Civil Engineer from Universidad de Chile.}{Premio \emph{Colegio de Ingenieros de Chile} al mejor egresado de Ingenier\'{i}a Civil de la Universidad de Chile.} \\ \noalign{\medskip}
     & \tr{Second Prize, Best paper in Kuhmo Nectar Conference on Transportation Economics. Paper}{Segundo premio al mejor art\'{i}culo en la Kuhmo Nectar Conference on Transportation Economics. Art\'{i}culo} “Efficiency and Complementarity of Transit Subsidies and Other Urban Transport Policies” (\cvwith{} Leonardo Basso). \\ \\
...
2008-2009 & \tr{TA: Transport Systems Analysis, Universidad de Chile.}{Ayudante: An\'{a}lisis de Sistemas de Transporte, Universidad de Chile.}
\end{tabularx}
